package dependency.textureatlas.displayobject;

import dependency.textureatlas.HelperEnums.LoopMode;
import dependency.textureatlas.HelperEnums.SymbolType;
import dependency.textureatlas.JSONData.AnimationData;
import dependency.textureatlas.JSONData.AtlasData;
import dependency.textureatlas.JSONData.ElementData;
import dependency.textureatlas.JSONData.LayerData;
import dependency.textureatlas.JSONData.LayerFrameData;
import dependency.textureatlas.JSONData.Matrix3DData;
import dependency.textureatlas.JSONData.SpriteData;
import dependency.textureatlas.JSONData.SymbolData;
import dependency.textureatlas.JSONData.SymbolTimelineData;
...
class SpriteAnimationLibrary
{
	...
	@:access(dependency.textureatlas)
