function generateStage()
{
    ...
    var bg:FNFSprite = new FNFSprite(-600, -200).loadGraphic(Paths.image('darkness', 'stages/' + curStage));
	...
	handleft.frames = Paths.getSparrowAtlas('bg hand left', 'stages/' + curStage);
	...
	handright.frames = Paths.getSparrowAtlas('bg hand right', 'stages/' + curStage);
